...
export default function OnboardingForm() {
  const navigate = useNavigate({ from: "/auth/register-church/onboarding" });
  ...
  return (
    <Card className="border-none bg-transparent shadow-none w-full max-w-2xl">
      <CardHeader className="px-0">
        <CardTitle className="text-3xl font-bold">Church Details</CardTitle>
        <CardDescription>
