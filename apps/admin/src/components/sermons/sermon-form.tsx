...
export function SermonForm({ onSuccess, onCancel }: SermonFormProps) {
  ...
  return (
    <form
      ...
      className="space-y-4 py-4 flex-1 flex flex-col h-full"
    >
      ...
      <div className="flex gap-2 pt-4 border-t mt-4">
        ...
        <Button type="submit" className="flex-1" disabled={createSermon.isPending}>
